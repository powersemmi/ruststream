...
- **[ruststream on docs.rs](https://docs.rs/ruststream)** - the core crate. Build it with all
  features to see the runtime, codecs, AsyncAPI, metrics, and conformance modules:
  [docs.rs/ruststream (all features)](https://docs.rs/crate/ruststream/latest/features).
- **[ruststream-cli on docs.rs](https://docs.rs/ruststream-cli)** - the command-line tool.
