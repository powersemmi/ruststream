...
| Kafka | [`ruststream-rdkafka`](https://github.com/powersemmi/ruststream-rdkafka) | Apache Kafka (группы консьюмеров, отслеживаемые коммиты, транзакции, конвейеры exactly-once) | [powersemmi.github.io/ruststream-rdkafka](https://powersemmi.github.io/ruststream-rdkafka/) |
...
| Google Cloud Pub/Sub | [`ruststream-gcp-pubsub`](https://github.com/powersemmi/ruststream-gcp-pubsub) | Pub/Sub через официальный клиент (ключи порядка доставки, подтверждение exactly-once, политики dead-letter) | [powersemmi.github.io/ruststream-gcp-pubsub](https://powersemmi.github.io/ruststream-gcp-pubsub/) |
...
Свой `Config` и параметры подключения каждый крейт брокера документирует сам. Если подписке нужны
