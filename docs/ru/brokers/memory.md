...
политики, и потому не знает, какой брокер его выполняет, - а файлу, где находятся и тело, и точка
...
которому гоняет брокер в рабочей системе, поэтому хендлер, его middleware и декодирование ведут
себя здесь ровно так же, как будут вести себя в рабочей системе. Чего он не делает - не эмулирует семантику доставки
