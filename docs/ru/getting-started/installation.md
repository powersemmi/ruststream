...
!!! note "Редакция и MSRV"
    ...
    Крейтам брокеров может требоваться более свежий тулчейн, чем ядру, если этого хотят их
    клиентские библиотеки; смотрите `rust-version` в самом крейте брокера.
