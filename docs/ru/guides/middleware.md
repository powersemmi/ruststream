...
едет на этой регистрации - ровно так же, как остальные шаги цепочки едут на позиции, названной
перед ними.
...
обычным статическим `Layer`, но привязанным к одному типу входа, поэтому он едет на одной
